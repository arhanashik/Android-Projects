package com.project.blackspider.musician.view.CustomRecycler;
...
public class IndexFastScrollRecyclerView extends RecyclerView {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (mEnabled) {
            //hide/show current playing item view
            if(ev.getAction()==MotionEvent.ACTION_UP) {
                if(MainActivity.mTrackContainer != null ) MainActivity.mTrackContainer.setVisibility(VISIBLE);
            }
            else if(ev.getAction()==MotionEvent.ACTION_MOVE) {
                if(MainActivity.mTrackContainer != null ) MainActivity.mTrackContainer.setVisibility(GONE);
            }
